...
export const translations = {
	en: {
		...
		shareImageAlt: 'Cyclope app icon with window management and menu bar usage examples',
		heroTagline: 'All-in-One Mac Control',
		seeApp: 'See The App',
		readPrivacy: 'Read Privacy',
		downloadMac: 'Download for Mac',
		versionLabel: 'Version',
		downloadNote: 'Free · macOS 26+',
		installCopy: 'Copy',
		installCopied: 'Copied',
		installCopyLabel: 'Copy Homebrew install command',
	...
	ko: {
		...
		shareImageAlt: '앱 아이콘과 창 관리, 메뉴 막대 사용 예시가 함께 보이는 Cyclope 이미지',
		heroTagline: 'All-in-One Mac Control',
		seeApp: '앱 보기',
		readPrivacy: '개인정보처리방침',
		downloadMac: 'Mac용 다운로드',
		versionLabel: '버전',
		downloadNote: '무료 · macOS 26+',
		installCopy: '복사',
		installCopied: '복사됨',
		installCopyLabel: 'Homebrew 설치 명령 복사',
		releaseNotes: '릴리스 노트',
		featureWindowTitle: 'Window Management',
